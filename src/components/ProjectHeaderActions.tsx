...
/**
 * Project-level action buttons (Request for Quotation / Request stock) for the
 * project drill-down header. These are PROJECT actions, so they belong on the
...
export default function ProjectHeaderActions({
  ...
  return (
    <div className="no-print flex flex-col items-end gap-2 shrink-0">
      ...
      <RequestStockButton projectId={projectId} />
    </div>
  );
}
